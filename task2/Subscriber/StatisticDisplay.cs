...
namespace task2.Subscriber
{
    public class StatisticsDisplay : ISubscriber
    {
        ...
        static void Show()
        {
            ...
            Console.WriteLine("Температура: {0}", FindAverage(temperatureList));
            Console.WriteLine("Влажность воздуха: {0}", FindAverage(humidityList));
            Console.WriteLine("Давление: {0}", FindAverage(pressureList));
        }
